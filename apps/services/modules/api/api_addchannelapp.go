...
// 添加配置
func (this *apiComp) AddChannelApp(session comm.IUserSession, req *pb.ApiAddChannelAppReq) (resp *pb.ApiAddChannelAppResp, errdata *pb.ErrorData) {
	var (
		err error
	)
	if err = this.module.model.addchannelapp(req.App); err != nil {
