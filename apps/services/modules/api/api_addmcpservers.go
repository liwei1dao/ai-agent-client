...
// 登录后台
func (this *apiComp) AddMcpServers(session comm.IUserSession, req *pb.ApiAddMcpServersReq) (resp *pb.ApiAddMcpServersResp, errdata *pb.ErrorData) {
	var (
		err error
	)
	if err = this.module.model.addmcpservers(req.Servers); err != nil {
