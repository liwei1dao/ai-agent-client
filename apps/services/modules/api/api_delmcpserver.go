...
// 登录后台
func (this *apiComp) DelMcpServers(session comm.IUserSession, req *pb.ApiDelMcpServersReq) (resp *pb.ApiDelMcpServerResp, errdata *pb.ErrorData) {
	var (
		err error
	)
	if err = this.module.model.delmcpservers(req.Ids); err != nil {
