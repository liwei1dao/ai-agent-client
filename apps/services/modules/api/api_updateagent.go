...
// 登录后台
func (this *apiComp) UpdateAgent(session comm.IUserSession, req *pb.ApiUpdateAgentReq) (resp *pb.ApiUpdateAgentResp, errdata *pb.ErrorData) {
	var (
		err error
	)
	if err = this.module.model.updateagent(req.Agent); err != nil {
