...
// 登录后台
func (this *apiComp) AddAgent(session comm.IUserSession, req *pb.ApiAddAgentReq) (resp *pb.ApiAddAgentResp, errdata *pb.ErrorData) {
	var (
		err error
	)
	if err = this.module.model.addagent(req.Agent); err != nil {
