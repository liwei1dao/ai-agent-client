...
/// Translate type screen: three-stage translation with bilingual bubbles.
/// Globe avatar (blue gradient), service chips Translation+STT+TTS,
/// language bar with supported languages hint, bilingual translation pair bubbles.
class TranslateTypeScreen extends ConsumerStatefulWidget {
  const TranslateTypeScreen({super.key, required this.agentId});
  final String agentId;

  @override
  ConsumerState<TranslateTypeScreen> createState() =>
      _TranslateTypeScreenState();
}

class _TranslateTypeScreenState extends ConsumerState<TranslateTypeScreen> {
